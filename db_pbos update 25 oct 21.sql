...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2021 at 11:03 AM
...
CREATE TABLE `ms_golongan` (
  `id_golongan` varchar(9) NOT NULL,
...
CREATE TABLE `ms_jenis_pengeluaran` (
  `id_jenis_pengeluaran` varchar(9) NOT NULL,
...
('123123', '123123123', 'Indomie', 'sdfsdfsdf', 'T', '225105', '222544', 'qwedasd', 1212100, 225105, 11),
('12313', '21312313123', 'IndoSulk', 'asdad', 'T', '232717', '222544', 'qwedasd', 1233, 232323, 22),
('225548', '1234124124143', 'Mie Ayam', 'sdfsdf', 'T', '225105', '195106', 'Jdgdfg', 12312311, 123123, 122);
...
INSERT INTO `ms_promo` (`id_promo`, `nama_promo`, `id_produk`, `tgl_awal`, `tgl_akhir`, `status`) VALUES
('183222', 'Promo 4', '12313', '2021-10-20', '2021-10-20', 'F');
...
('2037', 'Udang Windu', 'Jember', 'Jember', '2021-10-16', '081234578'),
('2054', 'Hayam Wuruk', 'Jember', 'Jember', '2021-09-28', '56598986'),
('K2151', 'Jawa', 'Bondowoso', 'Bondowoso', '2021-10-24', '');
