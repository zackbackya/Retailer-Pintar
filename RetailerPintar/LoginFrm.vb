...
Public Class LoginFrm
    ...
    Private Sub login()
        Try
            ...
            Else
                Call koneksi()
                Dim str As String
                str = "select * from ms_user where username = '" & txtUsername.Text & "' and password = '" & txtPassword.Text & "' and role <> 'KASIR'"
    ...
    Private Sub LoginFrm_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
